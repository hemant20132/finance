...
$(document).ready(function()
{
	...
	$('#incometable').dataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "incomedelete_processing.php"
	});
  ...
  var table = $('#incometable').DataTable();
    ...
    $('#incomedelete').click( function () {
	
	var finyear1  = $("#incometable").find(".selected td:eq(1)").text();
	var company1 = $("#incometable").find(".selected td:eq(2)").text();
	
	
	if (finyear1 == "" || company1 == "")
	{
		alert("select row!!!");
		return false;
	}
	
	location.href = "incomerecorddelete.php?companyinc="+company1+ "&finyearinc="+finyear1;
...
<div style="">
			...
			<div  id="mainwindow" style="position:absolute;left:300px;top:100px;">
				<input type="button" style="position:absolute;left:0px;top:-20px;" class="default" id="incomedelete" value="delete selected row record">
				
				<form action="#"  method="POST">
				<center><h4> Income File Data </h4></center>
