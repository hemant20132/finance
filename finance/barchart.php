...
$xAxisTickValues = array(
	new PHPExcel_Chart_DataSeriesValues('String', 'Worksheet!$A$1:$E$1', NULL, NULL),	//	Q1 to Q4
);
...
$dataSeriesValues = array(
	new PHPExcel_Chart_DataSeriesValues('Number', 'Worksheet!$A$2:E$2', NULL, 5));
...
$legend=NULL;
$title = new PHPExcel_Chart_Title('Total Revenue Sales');
$yAxisLabel = NULL;
...
$chart->setBottomRightPosition('F17');
