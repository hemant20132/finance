...
$objPHPExcel = $objReader->load("input-1.xlsx");
...
//  mysql_query($queryinsertinc,$conn);
...
$mininterest[$col]  . ",". $othliab[$col] . "," .$lngtliab[$col] . "," . $totalcurliab[$col] . "," .$reedmprfstk[$col] . "," .
...
mysql_query($queryinsertbal,$conn);
}
...
for ($col = 2; $col <= 6; $col++) 
 ...
 echo $queryinsertcash;
 

mysql_query($queryinsertcash,$conn);
}
