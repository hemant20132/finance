...
$(document).ready(function()
{
	...
	$('#balancetable').dataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "balancedelete_processing.php"
	});
  ...
  var table = $('#balancetable').DataTable();
	...
	var finyear2  = $("#balancetable").find(".selected td:eq(1)").text();
	var company2 = $("#balancetable").find(".selected td:eq(2)").text();
	

	if (finyear2 == "" || company2 == "")
	{
		alert("select row!!!");
		return false;
	}
	
	location.href = "balancerecorddelete.php?companybal="+company2+ "&finyearbal="+finyear2;
...
<div style="">
			...
			<div  id="mainwindow" style="position:absolute;left:300px;top:100px;">
				<input type="button" style="position:absolute;left:0px;top:-20px;" class="default" id="balancedelete" value="delete selected row record">
				
				<form action="#"  method="POST">
				<center><h4> Delete Balance Sheet Data </h4></center>
